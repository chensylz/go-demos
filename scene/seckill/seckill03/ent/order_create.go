...
func (oc *OrderCreate) SetMerchandiseID(i int) *OrderCreate {
	oc.mutation.SetMerchandiseID(i)
	return oc
}
...
func (oc *OrderCreate) check() error {
	if _, ok := oc.mutation.MerchandiseID(); !ok {
		return &ValidationError{Name: "merchandise_id", err: errors.New(`ent: missing required field "Order.merchandise_id"`)}
	}
...
func (oc *OrderCreate) createSpec() (*Order, *sqlgraph.CreateSpec) {
	...
	if value, ok := oc.mutation.MerchandiseID(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeInt,
			Value:  value,
			Column: order.FieldMerchandiseID,
		})
		_node.MerchandiseID = value
	}
